...
SECRET_KEY = "django-insecure-#x%7nczbmlonw1(hnh#6*znzf9na$^p6%y-muyv!)b1h^ysxvv"
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': '0sva1235Norway',  # Replace with your PostgreSQL password
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
